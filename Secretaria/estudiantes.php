    ...
    <div class="w3-row-padding w3-margin-bottom w3-animate-opacity" >
        <!--   <div class="w3-quarter" onclick="document.getElementById('modalES').style.display='block'" style="cursor: pointer;">
           <div class="w3-container w3-green w3-padding-16">
             <div class="w3-left"><i class="fa fa-plus w3-xxxlarge"></i>
             </div>
               <div class="w3-right">
                 <h3 id="ingresos_b"></h3>
               </div>
...
<form action="fun/alumnos/ingresar.php" method="POST">
<div class="w3-row-padding">
  ...
  <div class="w3-half">
    ...
    <option value="" disabled selected>Código de grado</option>
    <?php 
...
<div class="w3-row-padding">
  ...
  <div class="w3-half">
    ...
    <input class="w3-input w3-border" required type="text" name="apellido" >
  </div>
  <div class="w3-half">
    <label>Nombre</label>
...
<div class="w3-row-padding">
  ...
  <div class="w3-half">
    <label>Genero</label>
     <select class="w3-select w3-border" required name="option1">
 ...
 <br>
 <button class="w3-button w3-right w3-teal">Ingresar nuevo estudiante</button>
 <br>
  ...
  <h4 style="float: right;" onclick="document.getElementById('ver').style.display='none'">Cerrar <i class="fa fa-times" aria-hidden="true"></i></h4>    
      <table class="w3-table w3-striped" id="tabla">
        ...
        <tr>
          ...
          <td><?php echo utf8_decode($row[2])." ".utf8_decode($row[1]) ?></td>
          <td><?php echo $row[4] ?></td>
          <td><a href="fun/alumnos/edit.php?id=<?php echo $row[0] ?>"><i class="fa fa-eye "></i></a></td>
        </tr>
           <?php 
          }?>
...
<style type="text/css">
 ...
 <div class="w3-container" id="file" style="display: none">
  <h4 style="float: right;" onclick="document.getElementById('file').style.display='none'">Cerrar <i class="fa fa-times" aria-hidden="true"></i></h4>
   <center><h1>Ingresar estudiantes por archivo</h1>
    ...
    <br><br><br>
    <form action="fun/alumnos/mostrar.php" method="POST" enctype="multipart/form-data">
      <input REQUIRED id="archivo" type="file" onBlur='LimitAttach(this,1);' placeholder="Subir archivo" name="file"> <br>
  ...
  <div class="3-row">
<a href="grados/indexE.php"><button type="button" class="btn btn-success btn-lg"> <i class="fa fa-file" aria-hidden="true"></i>Grado</button></a>
    <a href="pdf/indexE.php"><button class="btn btn-info btn-lg"><i class="fa fa-file" aria-hidden="true"></i>Global</button></a>
  </div>
  <br>
  </center>
      </div>
