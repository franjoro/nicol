...
require '../../conexion.php';
  ...
  $query = mysqli_query($conexion, "SELECT * FROM grados");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a style="color: snow;" class="nav-link js-scroll-trigger" href="../Estudiantes.php">Volver al administrador</a>
            </li>
          </ul>
        </div>
      </div>
...
<div class="col-lg-12 col-md-6">
  ...
  <a href="../pdf/indexmag.php?id=<?php echo $rowi[0] ?>"><button class="bubbly-button"><?php echo $rowi[1]." ".$rowi[2] ?></button></a>
  <?php } ?>
  </div>
  </div>
  </div>
