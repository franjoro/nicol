 ...
 <div class="w3-row-padding w3-margin-bottom w3-animate-opacity" >
  ...
  <!-- <div class="w3-quarter" onclick="document.getElementById('modal_ingreso').style.display='block'" style="cursor: pointer;">
      <div class="w3-container w3-green w3-padding-16">
        <div class="w3-left">
            <i class="fa fa-plus w3-xxxlarge"></i>
        </div>
        <div class="w3-right">
          <h3 id="ingresos_b"></h3>
        </div>
...
<div class="w3-row-padding">
  ...
  <div class="w3-half">
    <label>Código</label>
    <input class="w3-input w3-border" type="text" name="cod" onkeypress="javascript: return ValidarNumero(event,this)" >
  </div>
  <div class="w3-half">
    <label>Grado</label>
    <input class="w3-input w3-border" type="text" name="grado" >
  </div>
 <br>
...
<label>Sección:</label> <br>
  <input class="w3-radio" type="radio" name="sec" value="A" >
<label>A</label>

<input class="w3-radio" type="radio" name="sec" value="B">
<label>B</label>
<input class="w3-radio" type="radio" name="sec" value="C">
<label>C</label>
<input class="w3-radio" type="radio" name="sec" value="D">
<label>D</label>
