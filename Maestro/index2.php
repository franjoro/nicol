...
<!--       <div id="principal">
      <div class="w3-container">
  <center><h1>Seleccione el reporte:</h1> <br>
  <div class="3-row">
...
<br>
  ...
  <!-- ============================================ -->
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">&copy; Colegio San Juan Bosco</p>
      </div>
      <!-- /.container -->
    </footer>
...
<?php 
  ...
  <center><h1>Seleccione una materia:</h1> <br> </center>
   ...
   <a href="php/Esview.php?id=<?php echo $row[0] ?>"><button style="cursor: pointer" type="button" class="w3-button w3-cyan"><i class="fa fa-book" aria-hidden="true"></i><?php echo utf8_encode($row[0]); ?></button></a>
