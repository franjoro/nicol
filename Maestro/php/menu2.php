...
if (isset($roww[0]) AND $roww[0]=='1') {
    $edit1="btn-info";
    $link1="notasE.php?id=".$id."&act=1";
    $texto1="*Ingresar notas. <br> N°Acumulados: <b>".$roww[1]."</b>" ;

  }else{
    $edit1="disabled";
    $link1="";
    $texto1="*<b>Imposible ingresar notas</b> por favor ingresar perfiles en sección de acumulados";
  }
...
if (isset($row2[0]) AND $row2[0]=='2') {
    $edit2="btn-info";
    $link2="notasE.php?id=".$id."&act=2";
    $texto2="*Ingresar notas. <br> N°Acumulados: <b>".$row2[1]."</b>" ;

  }else{
    $edit2="disabled";
    $link2="";
    $texto2="*<b>Imposible ingresar notas</b> por favor ingresar perfiles en sección de acumulados";
  }
$sql3=mysqli_query($conexion,"SELECT Role,Num FROM actividades WHERE idMa='$id' AND Role='3' AND Bimestre='$rowbi[0]'");
$row3=mysqli_fetch_array($sql3);
if (isset($row3[0]) AND $row3[0]=='3') {
    $edit3="btn-info";
    $link3="notasE.php?id=".$id."&act=3";
    $texto3="*Ingresar notas de examen" ;

  }else{
    $edit3="disabled";
    $link3="";
    $texto3="*<b>Imposible ingresar notas</b> por favor ingresar perfiles en sección de acumulados";
  }
...
if (isset($row4[0]) AND $row4[0]=='4') {
    $edit4="btn-info";
    $link4="notasE.php?id=".$id."&act=4";
    $texto4="*Ingresar notas de actividad de recuperación" ;

  }else{
    $edit4="disabled";
    $link4="";
    $texto4="*<b>Imposible ingresar notas</b> por favor ingresar perfiles en sección de acumulados";
  }
...
if (isset($row5[0]) AND $row5[0]=='5') {
    $edit5="btn-info";
    $link5="notasE.php?id=".$id."&act=5";
    $texto5="*Ingresar notas de actividad de recuperación" ;

  }else{
    $edit5="disabled";
    $link5="";
    $texto5="*<b>Imposible ingresar notas</b> por favor ingresar perfiles en sección de acumulados";
  }
 ?>
<!DOCTYPE html>
<html>
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-nav fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Notas</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-tSarget="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a style="color: snow;" class="nav-link js-scroll-trigger" href="menu.php?id=<?php echo $id ?>">Perfiles de <?php echo utf8_encode($row[1]) ?></a>
            </li>
    ...
    <header class="bg-primary text-white">
      <div class="container text-center">
        <h1>Selecciona la actividad para <b>ingreso</b> de notas</h1>
    ...
    <br><br>
<?php 
  if ($row[6]=='0' OR $row[7]=='0' OR $row[8]=='0') {
...
$abajo='<div align="center" class="container">
 ...
 ?>
    ...
    <center><h3 style="color:red"><?php echo $text ?></h3></center><br>
		<div class="row">
			<div class="col-md-4">
				<div class="w3-card-4" style="width:80%">
    <img src="../img/1.jpg" alt="Norway" style="width:100%">
    <div class="w3-container w3-center">
      <a href="<?php echo $link1 ?>"><button style="margin: 10px;" class="btn <?php echo  $edit1 ?> btn-lg">Primer 30%</button></a><br>
      <?php echo $texto1 ?>
    </div>
  </div>
</div>
<div class="col-md-4">
    ...
    <img src="../img/1.jpg" alt="Norway" style="width:100%">
    <div class="w3-container w3-center">
     <a href="<?php echo $link2 ?>"><button style="margin: 10px;" class="btn <?php echo $edit2 ?> btn-lg">Segundo 30%</button></a> <br>
     <?php echo $texto2 ?>
    </div>
  </div>
	</div>
