...
<div id="modal_ingresos" class="w3-modal">
  ...
  <p style="color:red">La siguiente acción tiene como consecuencia finalizar el bimestre escolar, lo que tiene repercusiones en toda la información plataforma, por favor verificar si tiene los permisos adecuados administrativos, el cambio no es reversible, información o ayuda comunicarse con el técnico.</p>
    </center>
 <br>
</div>
<br>
