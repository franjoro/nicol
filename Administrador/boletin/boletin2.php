 ...
 <body>
  ...
  // while ($rowoo = mysqli_fetch_array($query87)){
    ...
    $je = $rowi['Seccion'];
     ...
     $query50 = mysqli_query($conexion, "SELECT * FROM materias WHERE idG = '$id' AND ($semestre) ");
   ?>
 ...
 <!--<div class="table-responsive">-->
  ...
  // echo count($bum2);
   ...
   ?>
      ...
      <th scope="col"><span style="font-size: 12px;"><?php echo $bum2 ?></span></th>
      <?php } ?>
...
<?php 
   ...
   <tr>
    ...
    // ============================================================================================
     ...
     $query500 = mysqli_query($conexion, "SELECT * FROM materias WHERE idG ='$id' AND ($semestre) ");
    $promo=0;
     $putoelquelolea=0;
 ...
 $query3 = mysqli_query($conexion, "SELECT * FROM actividades WHERE IdG = '$id' AND idMa = '$tip[0]' AND Role = 1 AND Bimestre = '$bimestre' ");
   ...
   // $resulti = $hol->num_rows;
      // $count = $rowi9->num_rows;
       ...
       <td align=center><font style="font-size: 12px;"><?php echo $rowi9  ?></font></td>
...
if ($bimestre=='4') {
	?>
         ...
         <td align=center><font size=1><?php echo utf8_encode($row1[8])?></font></td>
