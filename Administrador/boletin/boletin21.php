...
//Codigo cuando para I y II Bimestre 

$query50 = mysqli_query($conexion, "SELECT * FROM materias WHERE idG = '$id'AND idMa<> 'GEO7A' AND idMa<> 'GEO7B' AND idMa<> 'GEO8A' AND idMa<> 'GEO8B' AND idMa<> 'GEO9A' AND idMa<> 'GEO9B' AND idMa<> 'GEO10A' AND idMa<> 'GEO10B' AND idMa<> 'GEO10C'");
