...
<header class="w3-container w3-indigo" style="margin-top:50px; height: 280px;">
  ...
  <a href="#"><img align="right" height="60" src="img/1.png"></a><br>
    </div>
...
<table style="max-width: 100%;" class=" table table-hover table-bordered">
  ...
  <tr>
    <?php 
    $resultado =($not1+$not2+$not3);
     ?>
    <td style="width: 20% !important;"><b>Total:</b></td>
    <td style="width: 20% !important;"></td>
    <td></td>
    <td style="width: 20% !important;"><b><?php echo $resultado ?></b></td>
    <!-- <td ></td> -->
  </tr>
  <!-- <tr>
    <td>Actividad 3</td>
