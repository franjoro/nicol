...
$ani = date('Y');
  ...
  <div style="margin-top: 40px; overflow: hidden">
	...
	<p>Informe del segundo 30% de acumulados para el <?php echo $columna." ". $ani?></p>
  ...
  <tbody>
    ...
    $query3 = mysqli_query($conexion, "SELECT * FROM actividades WHERE IdG = '$row[4]' AND idMa = '$row12[0]' AND Role = 2 AND Bimestre = '$bimestre' ");
...
<p style="display: inline-block;">_______________________________</p>
  <br><br><br>
